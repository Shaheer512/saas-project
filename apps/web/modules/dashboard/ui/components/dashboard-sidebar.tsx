...
import { CreditCardIcon,InboxIcon,LayoutDashboardIcon,Mic,LibraryBigIcon,PaletteIcon } from "lucide-react"
import Image from "next/image"
import Link from "next/link"
import { usePathname } from "next/navigation"
import { Sidebar,SidebarContent,SidebarFooter,SidebarGroup,SidebarGroupAction,SidebarGroupContent,SidebarGroupLabel,SidebarHeader,SidebarMenu,SidebarMenuItem,SidebarMenuButton,SidebarRail } from "@workspace/ui/components/sidebar";
                    ...
                    <SidebarMenuButton>
                        <UserButton 
                         ...
                         appearance={{
                            elements:{
                                rootBox: "w-full! h-8!",
                                userButtonTrigger:"w-full! p-2! hover:bg-sidebar-accent! hover:text-sidebar-accent-foreground! groun-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2!",
